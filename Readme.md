<h1>Hello 😎</h1>
<p>Welcome to my GitHub page! </br> I'm Rendi, Tech enthusiast from <img src="./images/pin.png" width="13"/> <b>Sidoarjo, Indonesia</b>. Fresh-graduate Informatics Engineering, Yogyakarta Technology University has 4 months internship experience as an AI engineer and 1 months intership experience as an web dev at Pt Semua Aplikasi Indonesia. Passionate about building models that fix problems. Relevant skills include data science, Machine Learning, Web Development, Mobile Development, Problem Solving, Programming, and Creative thinking</p>
